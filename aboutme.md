...
*PAIEMENTS*{:target="_blank"}
Depuis mars 2020, j’accepte uniquement les Virements Interac. Je transige les virements via mon ordinateur seulement (pour mieux protéger les données, y compris les miennes) et les mots de passe sont différents pour chaque client.{:target="_blank"}
